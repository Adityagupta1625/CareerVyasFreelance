...
export default function Youtube() {
  return (
    <div className=" w-full h-96 flex flex-col sm:flex-row  mb-20 overflow-hidden">
      
      <motion.div 
      whileInView={{x: ["-50vw","0vw"]}}
      transition={{ duration:4}}
      className="w-full sm:w-7/12 h-full flex flex-row items-center justify-center bg-[#6776FF] border-2 border-blue-800 relative">
        <Arrow />
        <Ellipse />
